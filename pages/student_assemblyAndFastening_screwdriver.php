...
$desiredToolId = 16; // The specific tool ID you want to display
        ...
        <div class="container">
            <div class="row align-items-stretch">
                <div class="col-md-8" data-aos="fade-up">
                    <img src="student/MyPortfolio/assets/img/Screwdriver.jpg" alt="Image" class="img-fluid" style="width: 500px; height: 350px;">
                </div>
